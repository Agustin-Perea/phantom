...
def make_sets():
    ...
    return training_data, training_labels, prediction_data, prediction_labels, pred_filename

def sortPred(path, pred):
    predictions = clf.predict_proba(pred)
    resultsList = []
...
for i in range(0,1):
    ...
    training_data, training_labels, prediction_data, prediction_labels, pred_filename = make_sets()
